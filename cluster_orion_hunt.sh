...
"$CONDA_PREFIX/bin/orion" hunt -n thelper --worker-trials 1 --working-dir 'sessions/orion' thelper/cli.py new --config 'configs/agrivis-ae.yml' --save-dir 'sessions/orion/{trial.id}/'
