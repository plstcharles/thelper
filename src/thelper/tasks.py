            ...
            return (self.get_input_key() == other.get_input_key() and
                    (
                        ...
                        (hasattr(self, "label_key") and isinstance(self.label_key, str) and
                            (other.get_gt_key() is None or self.label_key == other.get_gt_key()))
                        or
                    ...
                    and
                    # one class name array can be bigger than the other, as long as the overlap is the same
                    all([cls1 == cls2 for cls1, cls2 in zip(self.get_class_names(), other.get_class_names())]))
