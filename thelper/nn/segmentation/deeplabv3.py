...
class DeepLabV3ResNet50(thelper.nn.utils.Module):
    """
    This class is just a thin wrapper for deeplabv3_resnet101 (torchvision > 0.6).
...
class DeepLabV3ResNet101(thelper.nn.utils.Module):
    """
    This class is just a thin wrapper for deeplabv3_resnet101 (torchvision > 0.6).
