...
class Dataset(torch.utils.data.Dataset):
    ...
    Attributes:
        ...
        bypass_deepcopy: specifies whether this dataset interface can avoid the (possibly costly)
            deep copy inside :func:`thelper.data.LoaderFactory.get_loaders`, and instead only use
...
class ExternalDataset(Dataset):
    ...
    :func:`thelper.data.create_parsers` based on extra parameters; see the code there for more information.
