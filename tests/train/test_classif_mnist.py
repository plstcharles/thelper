...
def test_classif_mnist():
    if os.path.isdir("data/saved/test-classif-mnist"):
        shutil.rmtree("data/saved/test-classif-mnist")
    ...
    if os.path.isdir("data/saved/test-classif-mnist-finetune"):
        shutil.rmtree("data/saved/test-classif-mnist-finetune")
